#
#  Be sure to run `pod spec lint NSR_SDK_v3_swift.podspec' to ensure this is a
...
Neosurance SDK - Collects info from device sensors and from the hosting app - Exchanges info with the AI engines - Sends the push notification - Displays a landing page - Displays the list of the purchased policies
  ...
  spec.homepage     = "https://github.com/neosurance/NeosuranceSDK_v3_swift.git"
  ...
  spec.author             = { "Neosurance" => "info@neosurance.eu" }
  # Or just: spec.author    = ""
  # spec.authors            = { "" => "" }
